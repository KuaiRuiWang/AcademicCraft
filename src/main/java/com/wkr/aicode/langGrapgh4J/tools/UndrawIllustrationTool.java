package com.wkr.aicode.langGrapgh4J.tools;
...
import com.wkr.aicode.langGrapgh4J.model.enums.ImageCategoryEnum;
...
public class UndrawIllustrationTool {
    ...
    private static final String UNDRAW_API_URL = "https://undraw.co/_next/data/4Le0HCu1kse4MsGIK-QPR/search/%s.json?term=%s";

    @Tool("搜索插画图片，用于网站美化和装饰。请优先使用英文单词或单义词组作为关键词。")
